...
## Overview
Three full-page **system/utility status screens** for **Automation Engine** (internal
...
2. **Brand lockup** pinned top-center (absolute, `top: 40px`): `LogoMark size=34` + wordmark
   ("Automation Engine" 15px/800/`-.01em` over "Operations console" 12px/600 `--color-text-muted`).
