---
name: automation-engine-design
description: Use this skill to generate well-branded interfaces and assets for Automation Engine — the internal operations console for a Follow Up Boss call-automation platform — either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping.
user-invocable: true
---
...
- `ui_kits/automation-engine/` — interactive, high-fidelity recreation of the console. Lift
