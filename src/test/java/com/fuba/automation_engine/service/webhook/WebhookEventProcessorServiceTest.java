...
class WebhookEventProcessorServiceTest {
    ...
    private com.fuba.automation_engine.service.note.NoteEmissionService noteEmissionService;
    ...
    void setUp() {
        ...
        noteEmissionService = mock(com.fuba.automation_engine.service.note.NoteEmissionService.class);
