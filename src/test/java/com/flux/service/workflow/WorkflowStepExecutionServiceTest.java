...
class WorkflowStepExecutionServiceTest {
    ...
    void constructorRejectsDuplicateContributorKeys() {
        com.flux.service.workflow.spi.RunContextContributor a = stubContributor("dup");
        com.flux.service.workflow.spi.RunContextContributor b = stubContributor("dup");
    ...
    private static com.flux.service.workflow.spi.RunContextContributor stubContributor(String key) {
        return new com.flux.service.workflow.spi.RunContextContributor() {
            @Override
            public String key() {
                return key;
            }
            ...
            public java.util.Map<String, Object> contribute(
                    com.flux.service.workflow.spi.RunContextRequest request) {
