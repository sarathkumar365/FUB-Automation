...
| File | What it covers |
|---|---|
| `../Flux Design System/` (repo root) | **UI design source of truth** — brand foundations, tokens, component patterns, console UI kit. Start with its `HANDOFF.md`. (See AGENTS.md.) |
