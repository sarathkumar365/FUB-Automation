...
For the architectural response — a layered fix that resolves the #20/#23/#24/#25 bug family at the design level rather than per-bug patches — see [`Docs/features/state-change-events/design.md`](../features/state-change-events/design.md).
