...
**Phase plan:** [`Docs/features/domain-events/README.md`](../domain-events/README.md)

## What changed and why

After deliberation against the field observations in [`Docs/features/agent-followup-enforcement/plan.md`](../agent-followup-enforcement/plan.md), the original "layered fix" framing here (Layer 0/1/2/3/5 over the existing webhook-as-trigger model) was reframed as a model change rather than a patch stack:
