...
> Canonical plan: [plan.md](./plan.md) · Phase tracker: [phases.md](./phases.md) · Decision: [RD-008](../../repo-decisions/RD-008-profile-enrichment-inferred-kind.md)
...
- **Separate `inferredKind`, not overwriting `kind`.** See [RD-008](../../repo-decisions/RD-008-profile-enrichment-inferred-kind.md).
...
durable fix: infer the classification ourselves, early, with evidence. Tracked as
[known-issue #34](../../engineering-reference/known-issues.md).
