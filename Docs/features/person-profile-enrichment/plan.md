...
> Overview: [README.md](./README.md) · Phases: [phases.md](./phases.md) · Decision: [RD-008](../../repo-decisions/RD-008-profile-enrichment-inferred-kind.md)
...
| `inferredKind` | string | loose string, **not** an enum (e.g. `realtor`, `mortgage_agent`, `lender`); see RD-008 |
...
`kind` (the existing FUB-stage-derived column) is **untouched** — see RD-008.
...
- **New:** [RD-008 — inferred classification is a separate field; HUMAN > AUTO precedence](../../repo-decisions/RD-008-profile-enrichment-inferred-kind.md).
