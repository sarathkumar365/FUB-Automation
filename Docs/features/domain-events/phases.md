...
Status: `IN PROGRESS` — framework + one synthesized fixture landed; real DB-extracted fixtures pending. See [phase-0-implementation.md](./phase-0-implementation.md) for details.
