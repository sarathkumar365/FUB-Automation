...
**Decision:** [RD-007](../repo-decisions/RD-007-profile-enrichment-inferred-kind.md). **Plan/phases:** [plan.md](../features/person-profile-enrichment/plan.md) · [phases.md](../features/person-profile-enrichment/phases.md).
